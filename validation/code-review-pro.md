---
description: "执行结构化代码审查（可选自动修复）"
argument-hint: "[--project=<path>] [--scope=diff|staged|all|repo] [--profile=standard|strict] [--fix]"
version: "2.0.0"
tags: ["code-review", "quality", "security", "production-ready"]
dependencies: []
output-type: "file"
---
